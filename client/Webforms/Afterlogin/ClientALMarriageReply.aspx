<%@ Page Title="" Language="C#" MasterPageFile="~/client/Webforms/Afterlogin/ClientALMasterPage.master" AutoEventWireup="true" CodeFile="ClientALMarriageReply.aspx.cs" Inherits="client_Webforms_Afterlogin_Default" %>
    ...
    <table style="width:80%; background-color:#ffff99;" class="text">
        <tr>
            ...
            <td  style="text-align:right; vertical-align:middle;color:Maroon; font-size:40px;" colspan="4">
                Marriage Registration Confirm</td>
        </tr>      
